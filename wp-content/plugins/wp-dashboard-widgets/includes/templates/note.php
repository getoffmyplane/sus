<div class='wp-dashboard-widget-wrap note-widget' data-widget-type='note' data-color-text='<?php echo $widget_meta['color_text']; ?>' data-widget-color='<?php echo $widget_meta['color']; ?>'>
